...
rem
rem Dowload and install Temurin OpenJDK17U jdk
rem
set "JavaVersion=17"
set "JavaRelease=17.0.9"
set "JavaBuild=9"
rem
pushd %~dp0
set "_WorkPath=%cd%"
...
set "JdkArchive=OpenJDK17U-jdk_x64_windows_hotspot_%JdkName%.zip"
set "UrlBase=https://github.com/adoptium/temurin17-binaries/releases/download/%JdkDirName%.1"
rem
